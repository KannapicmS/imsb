...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Updates ⭕️', url='https://t.me/sasi7654/12')
            ],
            [
    ...
    buttons = [
        [
            InlineKeyboardButton('⭕️ Support', url='https://t.me/cmz_filimz'),
            InlineKeyboardButton('Channel ⭕️', url='https://t.me/+iSYT96ZcTrw5YWU9')
        ],
        [
